...
void *handlereq_new(ThreadData threadData)
{
    ...
    if(clientSocket!=0)
    {
        ...
        cout<<"Request id "<<threadData.counter<<" is in processing"<<endl;
    ...
    cout<<"Request id "<<threadData.counter<<" is Compiling"<<endl;
    ...
    cout<<"Request id "<<threadData.counter<<" is Executing"<<endl;
    ...
    cout<<"Request id "<<threadData.counter<<" is done"<<endl;
...
void *handlereq_status(int clientSocket)
{
    ...
    cout<<"Request id "<<g<<" : Checking status"<<endl;
